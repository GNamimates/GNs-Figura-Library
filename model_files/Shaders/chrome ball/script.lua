...
function player_init()
  ...
  local ChromeFrag = [==[
    ...
    void main() {
        ...
        //vec4 worldNormal = vec4(MayaMatrix * normal ,0); //calculates actual normal
	    vec3 reflection = refl(-V, FakeNormal.xyz);
	    fragColor = vec4(texture(Sampler0,toAngle(reflection)).rgb*mix(0,1,min(FakeNormal.y+1,1)),0);
    }
  ]==]
